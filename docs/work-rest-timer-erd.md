...
```typescript
export const useWorkRestTimer = (): [WorkRestTimerState, WorkRestTimerActions] => {
  // Implementation
}
```
...
export const WorkRestTimer = ({ className, onSessionComplete }: WorkRestTimerProps) => {

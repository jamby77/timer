  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        'shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed',
        'disabled:opacity-50',
        className
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          'rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)]',

...
export const requestAnimationFrame = root.requestAnimationFrame.bind(root) as typeof window.requestAnimationFrame;
export const cancelAnimationFrame = root.cancelAnimationFrame.bind(root) as typeof window.cancelAnimationFrame;
